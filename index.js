...
var SceneB = new Phaser.Class({
    ...
    preload: function ()
    {
        this.load.image('back2', 'assets/backgrounds/menue.png');
        this.load.audio('click', [
        "assets/Audio/mouseclick.wav"
        ]);
    },
    ...
    create: function ()
    {
      ...
      var h = this.add.text(16, 15, 'Start', { fontSize: '32px', fill: '#fff' });
      h.setInteractive({ useHandCursor: true  });
      h.on('pointerover',function(pointer){
        console.log('hover');
        h.setTint(0xff00ff, 0xffff00, 0x0000ff, 0xff0000);
      });
      ...
      hw.on('pointerover',function(pointer){
        console.log('hover');
        hw.setTint(0xff00ff, 0xffff00, 0x0000ff, 0xff0000);
      });
      hw.on('pointerout',function(pointer){
        console.log('out');
        hw.clearTint()
      });
      hw.on('pointerdown', () => {
      ...
      dr.on('pointerover',function(pointer){
        console.log('hover');
        dr.setTint(0xff00ff, 0xffff00, 0x0000ff, 0xff0000);
      });
      dr.on('pointerout',function(pointer){
        console.log('out');
        dr.clearTint()
      });
      dr.on('pointerdown', () => {
...
var Dreams = new Phaser.Class({
    ...
    function Dreams ()
    {
        Phaser.Scene.call(this, { key: 'Dreams' });
    },
...
var config = {
    ...
    scene: [ Scene0, SceneA, SceneB, SceneC, SceneD,  SceneE, Dreams],
};
